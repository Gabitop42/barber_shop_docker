package com.tiyay.barberShop.asistencia.service.impl;
...
public class AsistenciaServiceImpl implements AsistenciaService {
    ...
    public AsistenciaServiceImpl(AsistenciaRepository asistenciaRepository, AsistenciaMapper mapper, UsuarioRepository usuarioRepository) {
    ...
    @Override
    public void crearAsistenciasDiarias() {
